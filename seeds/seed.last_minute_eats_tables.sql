...
('Camembert Bread Bowl', 20, 'minutes', '{"1 Camembert Cheese", "1 Tablespoon Garlic Paste", "2 tablespoons Butter", "1 Circular Bread Loaf"}', '{"Cut off the top of the bread loaf, and scoop out a hole large enough to fit the camembert.", "Microwave butter and garlic to create the garlic butter.", "Butter the inside of the bread bowl and lid with the garlic butter.", "Cut the top off of the camembert and place in bowl. Bake for 15 minutes at 180°C (350°F).", "Serve with the loaf innards and enjoy."}', 'https://img.buzzfeed.com/video-api-prod/assets/bc1e5786c62b40488ae775f245756d6f/Bread_Bowl_Still_3.jpg'),
